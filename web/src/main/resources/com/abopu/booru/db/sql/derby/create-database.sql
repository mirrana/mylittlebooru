...
--   CONSTRAINT U_FILETYPES UNIQUE (FILETYPE_NAME)
-- );
...
CREATE TABLE FILES (
  ...
  --   CONSTRAINT FK_FILES_FILETYPES FOREIGN KEY (FILE_TYPE) REFERENCES FILETYPES (FILETYPE_ID),
...
CREATE TABLE TAGS (
  ...
  CONSTRAINT FK_TAGS_TAG_CATEGORIES FOREIGN KEY (TAG_CATEGORY) REFERENCES TAG_CATEGORIES (TAGCATEGORY_ID),
...
CREATE TABLE FILE_TAGS (
  ...
  CONSTRAINT FK_FILE_TAGS_FILES FOREIGN KEY (FILE_ID) REFERENCES FILES (FILE_ID),
  CONSTRAINT FK_FILE_TAGS_TAGS FOREIGN KEY (TAG_ID) REFERENCES TAGS (TAG_ID)
);